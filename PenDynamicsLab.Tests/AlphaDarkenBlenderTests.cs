...
/// </para>
/// <para>
/// <b>Nothing calls this yet, deliberately.</b> Wash lives in the Paint surface (issue 72) and has
/// not been built; the stroke tabs keep the naive behaviour on purpose (issue 68). These tests are
/// the evidence behind that decision — they are what turned "per-sample opacity capped at its own
/// value" from a hope into a settled design — and they will fail loudly if a SkiaSharp upgrade
/// takes the capability away before it is used.
/// </para>
/// </remarks>
