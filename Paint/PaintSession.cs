...
namespace PenDynamicsLab.Paint;
...
/// region of it -- see <see cref="PaintViewport"/> and issue 73.
/// </para>
/// <para>
/// One surface, not two. There is no raw comparison here, which is a decision rather than a
/// shortfall: with per-brush dynamics there would be no single processed stream for a raw one to be
/// compared against. Issue 72 records that.
/// </para>
/// <para>
